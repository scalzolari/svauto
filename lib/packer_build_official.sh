...
#		--roles=centos-xen,cloud-init,bootstrap,grub-conf,post-cleanup $DRY_RUN_OPT
	...
	./image-factory.sh --release=dev --base-os=centos68 --base-os-upgrade --product=svpts --version=7.30 --qcow2 --ova --vhd --vm-xml --md5sum --sha1sum \
	...
	./image-factory.sh --release=dev --base-os=centos68 --base-os-upgrade --product=svsde --version=7.45 --qcow2 --ova --vhd --vm-xml --md5sum --sha1sum \
	...
	./image-factory.sh --release=dev --base-os=centos72 --base-os-upgrade --product=svsde --version=7.45 --qcow2 --ova --vhd --vm-xml --md5sum --sha1sum \
		--roles=centos-xen,cloud-init,bootstrap,grub-conf,svsde,svusagemanagement,svsubscribermapping,vmware-tools,post-cleanup $DRY_RUN_OPT
       	...
       	# SDE 7.45 on CentOS 6
#	./image-factory.sh --release=dev --base-os=centos68 --base-os-upgrade --product=svsde --version=7.40 --qcow2 --ova --vhd --vm-xml --md5sum --sha1sum \
...
#	./image-factory.sh --release=dev --base-os=centos68 --base-os-upgrade --product=svspb --version=6.60 --qcow2 --ova --vhd --vm-xml --md5sum --sha1sum \
...
#	./image-factory.sh --release=dev --base-os=centos68 --base-os-upgrade --product=svpts --version=7.40 --qcow2 --ova --vhd --vm-xml --md5sum --sha1sum \
...
#	./image-factory.sh --release=dev --base-os=centos68 --base-os-upgrade --product=svpts --version=7.40 --product-variant=xen-1 --qcow2 --ova --vhd --vm-xml --md5sum --sha1sum \
...
#		--roles=centos-xen,cloud-init,bootstrap,grub-conf,svpts,vmware-tools,post-cleanup $DRY_RUN_OPT --versioned-repo --experimental-repo
	...
	./image-factory.sh --release=dev --base-os=centos68 --base-os-upgrade --product=svspb --version=7.00 --qcow2 --ova --vhd --vm-xml --md5sum --sha1sum \
