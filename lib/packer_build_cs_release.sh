...
packer_build_cs_release()
{
	...
	./image-factory.sh --release=prod --base-os=centos6 --base-os-upgrade --product=cs-svsde --version=$SANDVINE_RELEASE --qcow2 --ova --vm-xml --md5sum --sha1sum \
		--roles=cloud-init,bootstrap,grub-conf,svsde,svusagemanagement,svsubscribermapping,svcs-svsde,svcs,cloudservices-auto-config,vmware-tools,cleanrepo,post-cleanup $DRY_RUN_OPT
...
#		--roles=cloud-init,bootstrap,grub-conf,svsde,svusagemanagement,svsubscribermapping,svcs-svsde,svcs,cloudservices-auto-config,vmware-tools,cleanrepo,post-cleanup --labify $DRY_RUN_OPT
	...
	./image-factory.sh --release=prod --base-os=centos6 --base-os-upgrade --product=cs-svspb --version=$SANDVINE_RELEASE --qcow2 --ova --vm-xml --md5sum --sha1sum \
		--roles=cloud-init,bootstrap,grub-conf,svspb,svmcdtext,svreports,svcs-svspb,cloudservices-auto-config,vmware-tools,cleanrepo,post-cleanup $DRY_RUN_OPT
...
#		--roles=cloud-init,bootstrap,grub-conf,svspb,svmcdtext,svreports,svcs-svspb,cloudservices-auto-config,vmware-tools,cleanrepo,post-cleanup --labify $DRY_RUN_OPT
	...
	./image-factory.sh --release=prod --base-os=centos7 --base-os-upgrade --product=cs-svpts --version=$SANDVINE_RELEASE --qcow2 --ova --vm-xml --md5sum --sha1sum \
		--roles=cloud-init,bootstrap,grub-conf,svpts,svusagemanagementpts,svcs-svpts,cloudservices-auto-config,vmware-tools,cleanrepo,post-cleanup $DRY_RUN_OPT \
...
#		--roles=cloud-init,bootstrap,grub-conf,svpts,svusagemanagementpts,svcs-svpts,cloudservices-auto-config,vmware-tools,cleanrepo,post-cleanup --labify $DRY_RUN_OPT
